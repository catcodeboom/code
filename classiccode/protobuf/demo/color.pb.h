...
constexpr color color_MAX = DARK;
...
template <> struct is_proto_enum< ::colorspace::color> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::colorspace::color>() {
  return ::colorspace::color_descriptor();
}
