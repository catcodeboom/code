...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_people_people_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_people_people_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_people_2eproto[1];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_people_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::people, age_),
...
const char descriptor_table_protodef_people_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014people.proto\"5\n\006people\022\013\n\003age\030e \001(\005\022\014\n"
  "\004name\030\002 \001(\tJ\004\010\001\020\002J\004\010\003\020\004J\004\010\004\020eb\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_people_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_people_2eproto_sccs[1] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_people_2eproto = {
  false, false, descriptor_table_protodef_people_2eproto, "people.proto", 77,
  &descriptor_table_people_2eproto_once, descriptor_table_people_2eproto_sccs, descriptor_table_people_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_people_2eproto::offsets,
  file_level_metadata_people_2eproto, 1, file_level_enum_descriptors_people_2eproto, file_level_service_descriptors_people_2eproto,
};
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "people.name"));
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* people::_InternalSerialize(
  ...
  if (this->age() != 0) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(101, this->_internal_age(), target);
  }
