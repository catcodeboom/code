...
// int32 birthday = 1;
inline void people::clear_birthday() {
  birthday_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 people::_internal_birthday() const {
  return birthday_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 people::birthday() const {
  // @@protoc_insertion_point(field_get:people.birthday)
  return _internal_birthday();
}
inline void people::_internal_set_birthday(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  birthday_ = value;
}
inline void people::set_birthday(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_birthday(value);
  // @@protoc_insertion_point(field_set:people.birthday)
}
